            ...
            <div id="sectionsWrapper">
                <div id="section1" class="rfSections">
                    <div id="homeDescription">
                        <h1>Somos una firma mexicana de contadores públicos y consultores</h1>
                        <h2 class="tdropShadow">Destacada por su liderazgo en la prestación de servicios integrales y personalizados a las empresas privadas y a sus propietarios en nuestro país.</h2>
                    </div>
                ...
                <div id="section4" class="rfSections">
                    <div id="bolsaWrap" class="tdropShadow">
                        ...
                        <div class="innerBox">
                            <form action="mail/employment.php" name="employment-form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="halfColumn">
                                    ...
                                    <div id="schoolGroup">
                                        <div id="levelStudy" class="bolsaLine">
                                            <label for="">Grado de Estudios</label>
                                        </div>

                                        <div id="formStudent" class="bolsaLine">
                                            <label for=""><span>Estudiante universitario</span></label>
                                            <input name="student" type="checkbox"> 

                                        </div>

                                        <div id="formBachelor" class="bolsaLine">
                                            <label for=""><span>Licenciatura</span></label>
                                            <input name="bachelor" type="checkbox"> 
                                        </div>

                                        <div id="formMaster" class="bolsaLine">
                                            <label for=""><span>Maestría</span></label>
                                    ...
                                    <div id="formExperience" class="bolsaLine">
                                        ...
                                        <div class="bolsaLine">
                                            <label for="" class="innerLabel">Nombre de la empresa</label>
